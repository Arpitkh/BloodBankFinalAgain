/*Jsva File for the Realtime Blood Unit Availability Counters*/
...
public class bloodCount extends AppCompatActivity {
    ...
    private static final String URL = "https://api.myjson.com/bins/1bp425";         //JSON File link for the Available Blood Unit Display
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final StringRequest request = new StringRequest(URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {              //Fetches the JSON data for the Blood Unit Count
                progDailog.dismiss();
